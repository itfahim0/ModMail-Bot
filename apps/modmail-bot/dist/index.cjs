...
// ../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/@prisma/client/runtime/library.js
var require_library = __commonJS({
  "../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/@prisma/client/runtime/library.js"(exports2, module2) {
    "use strict";
...
// ../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/.prisma/client/index.js
var require_client = __commonJS({
  "../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/.prisma/client/index.js"(exports2) {
    "use strict";
    ...
    exports2.Prisma.GuardianScalarFieldEnum = {
      id: "id",
      name: "name",
      role: "role",
      createdAt: "createdAt",
    ...
    exports2.Prisma.TicketMessageScalarFieldEnum = {
      id: "id",
      ticketId: "ticketId",
      senderId: "senderId",
      content: "content",
    ...
    exports2.Prisma.GuildConfigScalarFieldEnum = {
      id: "id",
    ...
    exports2.Prisma.WarningScalarFieldEnum = {
      id: "id",
      userId: "userId",
    ...
    var config2 = {
      "generator": {
        ...
        "output": {
          "value": "/Users/kuasha/Dev/ModMail-Bot/node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
    ...
    warnEnvConflicts2({
      rootEnvPath: config2.relativeEnvPaths.rootEnvPath && path3.resolve(config2.dirname, config2.relativeEnvPaths.rootEnvPath),
      schemaEnvPath: config2.relativeEnvPaths.schemaEnvPath && path3.resolve(config2.dirname, config2.relativeEnvPaths.schemaEnvPath)
    });
...
// ../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/.prisma/client/default.js
var require_default = __commonJS({
  "../../node_modules/.pnpm/@prisma+client@6.19.1_prisma@6.19.1_typescript@5.9.3__typescript@5.9.3/node_modules/.prisma/client/default.js"(exports2, module2) {
    "use strict";
...
var envSchema = import_zod.z.object({
  DISCORD_TOKEN: import_zod.z.string().min(1, "DISCORD_TOKEN is required"),
  GUILD_ID: import_zod.z.string().optional(),
  LOG_CHANNEL_ID: import_zod.z.string().optional(),
  MODMAIL_CATEGORY_ID: import_zod.z.string().optional(),
  MOD_CHANNEL_ID: import_zod.z.string().optional(),
  WELCOME_CHANNEL_ID: import_zod.z.string().optional(),
  RULES_CHANNEL_ID: import_zod.z.string().optional(),
  GENERAL_CHANNEL_ID: import_zod.z.string().optional(),
  AUTO_ROLE_ID: import_zod.z.string().optional(),
  APP_PORT: import_zod.z.string().default("3001"),
  EXTERNAL_API_URL: import_zod.z.string().default("http://localhost:3001")
});
...
var setup_default = {
  data: new import_discord.SlashCommandBuilder().setName("modmail-setup").setDescription("Setup ModMail category").setDefaultMemberPermissions(import_discord.PermissionFlagsBits.ManageGuild),
...
// src/commands/index.ts
var import_meta = {};
var __dirname2 = import_path2.default.dirname((0, import_url.fileURLToPath)(import_meta.url));
var commandsCollection = new import_discord2.Collection();
var commands = [];
var loadCommands = async () => {
  ...
  const folders = import_fs.default.readdirSync(__dirname2).filter((f) => !f.endsWith(".js") && !f.endsWith(".ts"));
  for (const folder of folders) {
    const folderPath = import_path2.default.join(__dirname2, folder);
    if (!import_fs.default.statSync(folderPath).isDirectory()) continue;
    const files = import_fs.default.readdirSync(folderPath).filter((file) => file.endsWith(".js") || file.endsWith(".ts"));
    for (const file of files) {
      try {
        const filePath = `file://${import_path2.default.join(folderPath, file)}`;
...
async function handleCloseConfirmation(interaction) {
  ...
  if (userId) {
    try {
      ...
      const embed = new import_discord3.EmbedBuilder().setColor("#FF0000").setTitle("\u{1F512} Ticket Closed").setDescription(`Your ticket has been closed by staff.
**Reason:** ${reason}`).setTimestamp();
  ...
  if (config.logChannelId) {
    ...
    if (logChannel) {
      const logEmbed = new import_discord3.EmbedBuilder().setColor("#FF0000").setTitle("Ticket Closed").addFields(
...
async function handleMessageCreate(message) {
  ...
  if (message.channel.type === import_discord4.ChannelType.DM) {
    await handleDMMessage(message);
    return;
  }
  if (message.guild && config.categoryId && message.channel.type === import_discord4.ChannelType.GuildText && message.channel.parentId === config.categoryId) {
...
async function handleDMMessage(message) {
  ...
  let ticketChannel = guild.channels.cache.find(
    (ch) => ch.parentId === categoryId && ch.type === import_discord4.ChannelType.GuildText && Boolean(ch.topic?.includes(message.author.id))
  );
  if (!ticketChannel) {
    try {
      ...
      const welcomeEmbed = new import_discord4.EmbedBuilder().setColor("#00FF00").setTitle("\u{1F4E8} New ModMail Ticket").setDescription(
...
**Account Created:** <t:${Math.floor(
  ...
  const embed = new import_discord4.EmbedBuilder().setColor("#0099FF").setAuthor({
...
async function handleStaffReply(message) {
  ...
  if (message.channel.type !== import_discord4.ChannelType.GuildText) return;
  const userId = message.channel.topic?.match(/\((\d+)\)/)?.[1];
  if (!userId) return;
  try {
    const user = await message.client.users.fetch(userId);
    const embed = new import_discord4.EmbedBuilder().setColor("#00FF00").setAuthor({
      name: "Staff Reply",
      iconURL: message.author.displayAvatarURL()
...
function createDiscordClient() {
  const client = new import_discord5.Client({
    intents: [
      ...
      import_discord5.GatewayIntentBits.GuildMembers,
      import_discord5.GatewayIntentBits.GuildVoiceStates,
      import_discord5.GatewayIntentBits.GuildMessageReactions,
      import_discord5.GatewayIntentBits.GuildBans,
      import_discord5.GatewayIntentBits.GuildPresences,
      import_discord5.GatewayIntentBits.GuildInvites
    ],
    partials: [import_discord5.Partials.Channel, import_discord5.Partials.Message]
  });
  client.once(import_discord5.Events.ClientReady, (c) => {
    logger.info(`Ready! Logged in as ${c.user.tag}`);
  });
  client.on(import_discord5.Events.InteractionCreate, async (interaction) => {
    try {
